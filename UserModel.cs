...
namespace ClinicBO
{
    public class UserModel : UtilityModel
    {
        ...
        private static string EditUserStatusByUserID_SP = "SP_UpdateUserStatus";
        private static string EditPlatFormyUserID_SP = "SP_UpdatePlatFormType";
                ...
                if (dataSet.Tables[1].Rows.Count > 0)
                {
                    ...
                    userList = (from DataRow row in data.Rows
                                select new UserModel()
                                {
                                    ...
                                    PlatFormTypeId = row.Field<int>("platformTypeId"),
        ...
        public Int64 EditUserStatusByUserId(string UserID,bool status)
        {
            Int64 RecordID = -1;
            Dictionary<object, object> parameters = new Dictionary<object, object>();
            parameters.Add("@UserID", UserID);
            ...
            DBManager.CreateUpdateData(EditUserStatusByUserID_SP, parameters, out RecordID);
            return RecordID;
        }

        public Int64 EditPlatFormByUserId(string UserID, int platformtypeid)
        {
            Int64 RecordID = -1;
            Dictionary<object, object> parameters = new Dictionary<object, object>();
            parameters.Add("@UserID", UserID);
            parameters.Add("@PlatformTypeId", platformtypeid);

            DBManager.CreateUpdateData(EditPlatFormyUserID_SP, parameters, out RecordID);
            return RecordID;
        }
